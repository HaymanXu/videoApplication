...
public class RemoveDislikeHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
        ...
        try{
            ...
            if (iterator.hasNext()) {
                ...
                Item updateVideoTableItem = updateVideoTableItem(videoTable, videoId, oldDislikeCount - 1);
    ...
    public Item updateVideoTableItem(Table videoTable, String videoId, int newDislikeCount) {
        UpdateItemSpec updateVideoTableItemSpec = new UpdateItemSpec()
                .withPrimaryKey("video_id", videoId)
                .withUpdateExpression("set #lk = :lk")
                .withNameMap(new NameMap().with("#lk", "dislikes_count"))
                .withValueMap(new ValueMap().withNumber(":lk", newDislikeCount))
